...
{
    unsigned int i=0;                        
    unsigned long no1,no2;                   
    unsigned long result=0;                  
    double div_result=0;                     
    unsigned char key,operator,flag=0;       
    unsigned char op1[10],op2[10],a;        
    unsigned long output[10],output1[10];    
    OSCCON = 0x72;                           
    TRISB = 0;                               
    TRISD = 0xf0;                            
    write_port = 0xf0;
...
#line 86 "TesteCalculadora.c"
            ...
            case '/':
                        ...
                        {   
                            ...
                            div_result = (float)no1/(float)no2;      
